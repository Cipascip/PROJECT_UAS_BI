...
if df is None:
    st.error("File `bansos_data_cleaned.parquet` tidak ditemukan. Jalankan `preprocess.py` melalui GitHub Actions.")
    st.stop()
...
fig1 = px.bar(kse_per_provinsi, x='provinsi', y='Jumlah', color='status_kse', barmode='stack',
              ...
              color_discrete_map={'menerima bansos': '#2980B9', 'Tidak menerima bansos': '#E74C3C'},
              height=600)
